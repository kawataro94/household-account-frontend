...
const LendingRecordTable = () => {
	const { fetchLendingRecords, fetchCategories } = useFetchData();
	const [{ data: lendingRecords }, { data: categories }] = useQueries([
	...
	return <Container {...{ data: lendingRecords, columns }} />;
};
