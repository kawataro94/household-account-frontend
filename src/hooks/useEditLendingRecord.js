...
function useEditLendingRecord({ categories, places, members }) {
	const edit = useCallback(
		({ id, title, date, cost, category, place, paidBy, createBy }) => {
			...
			return httpClient.patch(`${serverUrl}/member/lending_records/${id}`, body);
		},
...
export default useEditLendingRecord;
